    ...
    >
      ...
      <meshBasicMaterial>
        <GradientTexture
          ...
          size={5} // Size (height) is optional, default = 1024
          width={5} // Width of the canvas producing the texture, default = 16
...
export function GlobeContainer() {
  ...
  return (
    ...
    <Canvas camera={{ position: [0, 0, 18], fov: 8 }}>
      ...
      <directionalLight position={[0, 1, 1]} intensity={3} color={white} castShadow shadow-mapSize={[1024, 1024]} />
